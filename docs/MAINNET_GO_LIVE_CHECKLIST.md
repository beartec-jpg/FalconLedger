...
- [ ] Mainnet **genesis** secret generated (not testnet seed)
- [ ] **AIRDROP** wallet address + secret (cold → warm for batch pay)
- [ ] **FAUCET** wallet address + secret (1B allocation after split)
- [ ] **DEV** wallet address + multi-sig / custody plan (0.5%)
- [ ] Initial **validator** keys (N operators) + bond plan
- [ ] Secrets backed up offline; never committed to git

### Network config

- [ ] **Network ID** chosen and documented
- [ ] Genesis / validators config templates filled (peers empty or private seed peers)
- [ ] UNL / validator public key list prepared (unpublished until T0)
- [ ] Public RPC hostnames reserved (DNS ready)
